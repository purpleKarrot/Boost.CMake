...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--  xsl:param name="admon.graphics.path" select="concat($boost.root, '/doc/xhtml/images/')" / -->
  <!--  xsl:param name="navig.graphics.path" select="concat($boost.root, '/doc/xhtml/images/')" / -->
